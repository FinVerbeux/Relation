...
- Multi-dossiers, timeline, vue tableau, audit qualité, interface mobile de consultation, historique de versions, import/export JSON/CSV, export PNG, rapport PDF et client autonome.
...
- Interface mobile : `docs/MOBILE_INTERFACE.md`
